...
package com.alfayedoficial.chucker.internal.data.entity
...
import com.alfayedoficial.chucker.internal.support.FormatUtils
import com.alfayedoficial.chucker.internal.support.FormattedUrl
import com.alfayedoficial.chucker.internal.support.JsonConverter
import com.alfayedoficial.chucker.internal.support.SpanTextUtil
...
internal class HttpTransaction(
    ...
    @ColumnInfo(name = "responseTlsVersion") var responseTlsVersion: String?= null,
    @ColumnInfo(name = "responseCipherSuite") var responseCipherSuite: String?= null,
    @ColumnInfo(name = "requestPayloadSize") var requestPayloadSize: Long?= null,
    ...
    @ColumnInfo(name = "requestHeadersSize") var requestHeadersSize: Long?= null,
    ...
    @ColumnInfo(name = "responsePayloadSize") var responsePayloadSize: Long?= null,
    ...
    @ColumnInfo(name = "responseHeadersSize") var responseHeadersSize: Long?= null,
    ...
    @ColumnInfo(name = "graphQlOperationName") var graphQlOperationName: String?= null,
) {
